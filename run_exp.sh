...
# conda run -n simpo_data python scripts/init_decode_data.py --train_model meta-llama/Llama-3.2-3B-Instruct --ref_model meta-llama/Llama-3.2-3B-Instruct --epoch 1 --algo cpo --num_samples 2000 --debug --output_dir datasets/llama3_3b_ultrafeedback_ori --ori_rej;
...
# conda run -n simpo_data python scripts/init_decode_data.py --train_model Qwen/Qwen2.5-3B-Instruct --ref_model Qwen/Qwen2.5-3B-Instruct --epoch 1 --algo cpo --num_samples 2000 --debug --output_dir datasets/qwen25_3b_ultrafeedback_ori --ori_rej;
...
conda run -n simpo_data python scripts/init_decode_data.py --train_model meta-llama/Llama-3.2-3B-Instruct --ref_model meta-llama/Llama-3.2-3B-Instruct --epoch 1 --algo cpo --num_samples 2000 --debug --output_dir datasets/llama3_3b_ultrafeedback;
...
conda run -n simpo_data python scripts/init_decode_data.py --train_model Qwen/Qwen2.5-3B-Instruct --ref_model Qwen/Qwen2.5-3B-Instruct --epoch 1 --algo cpo --num_samples 2000 --debug --output_dir datasets/qwen25_3b_ultrafeedback;
