...
do
    ...
    do
        ...
        conda run -n simpo python scripts/run_simpo_eval.py training_configs/llama-3-3b-instruct-$algo-v2.yaml  epoch=$i exp_name=$algo-$i run_name=llama3b_0.2_10.0_beta1.0_new_loss;\
    done
done