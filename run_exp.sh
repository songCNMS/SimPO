...
do
    ...
    do
        ...
        conda run -n simpo python scripts/run_simpo_eval.py training_configs/llama-3-3b-instruct-$algo-v2.yaml  epoch=$i exp_name=$algo-$i run_name=llama3b_original_rejected;\
    done
done
...
do
    ...
    do
        ...
        conda run -n simpo python scripts/run_simpo_eval.py training_configs/qwen25-3b-instruct-$algo-v2.yaml  epoch=$i exp_name=$algo-$i run_name=qwen25_3b_original_rejected;\
    done
done
...
do
    ...
    do
        conda run -n simpo_data python scripts/decode_data.py --ref_model meta-llama/Llama-3.2-3B-Instruct --train_model /home/lesong/codes/SimPO/outputs/$algo_$i --epoch $i  --algo $algo --output_dir datasets/llama3_3b_ultrafeedback;\
        conda run -n simpo python scripts/run_simpo.py training_configs/llama-3-3b-instruct-$algo-v2.yaml epoch=$i;\
        conda run -n simpo python scripts/run_simpo_eval.py training_configs/llama-3-3b-instruct-$algo-v2.yaml  epoch=$i exp_name=$algo-$i run_name=llama3b_ref_rejected;\
    done
done
...
do
    ...
    do
        conda run -n simpo_data python scripts/decode_data.py --ref_model Qwen/Qwen2.5-3B-Instruct --train_model /home/lesong/codes/SimPO/outputs/$algo_$i --epoch $i  --algo $algo --output_dir datasets/qwen25_3b_ultrafeedback;\
        conda run -n simpo python scripts/run_simpo.py training_configs/qwen25-3b-instruct-$algo-v2.yaml epoch=$i;\
        conda run -n simpo python scripts/run_simpo_eval.py training_configs/qwen25-3b-instruct-$algo-v2.yaml  epoch=$i exp_name=$algo-$i run_name=qwen25_3b_ref_rejected;\
    done
done